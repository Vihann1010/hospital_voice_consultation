...
import type { LabItemStatus, LabPriority, LabRequestSummary, PendingLabOrder } from "@/lib/types/lab";
import { BILLING_LABEL, REQUEST_STATUS_LABEL, canRegisterLab } from "@/lib/types/lab";
